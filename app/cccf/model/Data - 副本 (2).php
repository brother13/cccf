...
class Data extends Common
{
    ...
    public function saveCflistone($cflistid, $data)
    {
        ...
        $field = ['cbr', 'ah', 'sqzxr', 'bzxr', 'type', 'status', 'startdate', 'enddate', 'note', 'isvoid', 'ccqk', 'cfsf', 'ycbr', 'autocf', 'leixing', 'zbah','account'];
        $d = [];
        foreach ($field as $f) {
            if (isset($data[$f])) {
    ...
    public function getCfList($data)
    {
        ...
        $field = ['cbr', 'ah', 'sqzxr', 'bzxr', 'type', 'status', 'startdate', 'enddate', 'note', 'id cflistid', 'isvoid', 'inserttime', 'ccqk', 'cfsf', 'ycbr', 'autocf', 'leixing', 'zbah','account'];
    ...
    public function getCfListbyId($id)
    {
        ...
        $field = ['cbr', 'ah', 'sqzxr', 'bzxr', 'type', 'status', 'startdate', 'enddate', 'note', 'id cflistid', 'isvoid', 'inserttime', 'ccqk', 'ycbr', 'autocf', 'leixing', 'zbah','account'];
        $num = $this->getdb('cflist_v')->where($where)->count();
